pfUI_translation["enUS"] = {
  ...
  ["A new installation of |cff33ffccpf|rUI ships with 5 prebuilt design profiles. Click below if you wish to load one of these profiles."] = nil,
  ...
  ["Translate Outgoing Messages"] = "Translate Outgoing Messages",
  ["Silent Mode (No [TR] Prefix)"] = "Silent Mode (No [TR] Prefix)",
  ["Enable WIM Integration"] = "Enable WIM Integration",
