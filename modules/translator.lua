pfUI:RegisterModule("translator", "vanilla", function ()
  ...
  -- ============================================================
  -- LOGICA TRILINGUE (Sequito Intelligence v4.2.0)
  -- ============================================================
