pfUI:RegisterModule("firstrun", "vanilla:tbc", function ()
  ...
  pfUI.firstrun:AddStep("profile", function()
    ...
    f.Apex:SetWidth(120)
    f.Apex:SetHeight(22)
    f.Apex:SetPoint("BOTTOM", 0, 115)
    f.Apex:SetTextColor(1, 0.82, 0)
    f.Apex:SetText("APEX")
    ...
    f.Modern:SetPoint("BOTTOM", -65, 85)
    ...
    f.Nostalgia:SetPoint("BOTTOM", 65, 85)
    ...
    f.Legacy:SetPoint("BOTTOM", 65, 60)
