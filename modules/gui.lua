  ...
  do -- Generate Config UI
    CreateGUIEntry(T["About"], nil, function()
      ...
      donate:SetScript("OnClick", function()
        pfUI.chat.urlcopy.CopyText("https://ko-fi.com/darckrovert")
      end)
      SkinButton(donate)
    ...
    CreateGUIEntry(T["Translator"] or "Traductor", nil, function()
      ...
      CreateConfig(U.translator, T["Silent Mode (No [TR])"] or "Modo Silencioso (Sin [TR])", C.translator, "silent_mode", "checkbox")
      ...
      CreateConfig(U.translator, T["Tag Color"] or "Color de Etiqueta [TR]", C.translator, "tag_color", "dropdown", pfUI.gui.dropdowns.translator_tag_color)
